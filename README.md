...
The files land under `resources/views/vendor/permission/`, and from that point
...
```go
	_ "your/module/path/storage/framework/views/vendor/permission"
```
...
Terminals return `*Permission` and `[]*Permission`. Keep those pointers intact:
